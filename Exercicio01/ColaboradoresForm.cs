...
namespace Exercicio01
{
    public partial class ColaboradoresForm : Form
    {
        ...
        private void Alterar()
        {
            ...
            colaborador.Programador = Convert.ToBoolean(ckbProgramador.Text);
            ...
            SqlCommand comando = new SqlCommand();
            comando.Connection = conexao;
            comando.CommandText = @"UPDATE colaboratores SET nome = @NOME,cpf = @CPF, salario = @SALARIO, sexo = @SEXO, cargo = @CARGO,programador = @PROGRAMADOR WHERE id =@ID";
        ...
        private void dgvColaboradores_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbSexo.Text = colaborador.Sexo.ToString();
            cbCargo.Text = colaborador.Sexo.ToString();
            ckbProgramador.Text = colaborador.Programador.ToString();
            conexao.Close();
